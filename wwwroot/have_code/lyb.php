<html xmlns="http://www.w3.org/1999/html" xmlns="http://www.w3.org/1999/html">
    ...
    <style>
        ...
        body{
            background:url(../pic/hack1.gif) no-repeat center top;
    ...
    <body>
        <div class="div1">
            ...
            <form action="lyb.php" method="post">
                ...
                <br>
                <select name="vid" style="width: 500px;height: 40px">
                ...
                <br>
                <input type="submit" value="提交" style="width: 400px;font-size: 30px;margin-left: 7%">
            </form>
        </div>
    </body>
