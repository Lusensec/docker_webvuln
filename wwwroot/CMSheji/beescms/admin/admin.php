...
if (file_exists(TP_PATH . $_confing['web_template'] . '/tpl_confing.php')) {
    include(TP_PATH . $_confing['web_template'] . '/tpl_confing.php');
}
...
if ($main_nav == 'content') {
    ...
    if ($model == 'alone') {
        $iframe_url = 'admin_content_alone.php?action=content_list';
    }
