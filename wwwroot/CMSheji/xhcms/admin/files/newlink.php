...
<div class="mainbar">
    ...
    <div class="page-head">
        ...
        <div class="bread-crumb pull-right">
            ...
            <a href="#" class="bread-current">添加链接</a>
        </div>
                            ...
                            <div class="padd">
                                ...
                                <form class="form-horizontal" role="form" method="post" action=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="jieshao" class="form-control col-lg-12"
                                                      placeholder="jieshao"></textarea>
                                        </div>
                                    </div>
