                            ...
                            <div class="padd">
                                ...
                                <form class="form-horizontal" role="form" method="post" action=""
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="ad1" class="form-control col-lg-12"
                                                      placeholder="ad-1"><?php echo $ad['ad1'] ?></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="ad2" class="form-control col-lg-12"
                                                      placeholder="ad-2"><?php echo $ad['ad2'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <textarea name="ad3" class="form-control col-lg-12"
                                                      placeholder="ad-2"><?php echo $ad['ad3'] ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-offset-1 col-lg-9">
                                            <button type="submit" class="btn btn-primary" name="save" value="1">保存
                                            </button>
