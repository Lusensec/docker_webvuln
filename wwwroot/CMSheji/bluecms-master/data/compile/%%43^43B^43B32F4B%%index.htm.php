<?php /* Smarty version 2.6.22, created on 2023-12-22 14:08:37
...
<?php $this->_cache_serials['D:/phpstudy_pro/WWW/wwwroot/CMSheji/bluecms-master/data/compile/\%%43^43B^43B32F4B%%index.htm.inc'] = 'aa1aff3a524538eafd5457f6d9b247ce'; ?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
"><?php echo ((is_array($_tmp=$this->_tpl_vars['hot_news'][$this->_sections['h']['index']]['title'])) ? $this->_run_mod_handler('mb_substr', true, $_tmp, 0, 18) : smarty_modifier_mb_substr($_tmp, 0, 18)); ?>
		...
		<div id="top_r">
			<?php if ($this->caching && !$this->_cache_including): echo '{nocache:aa1aff3a524538eafd5457f6d9b247ce#0}'; endif;$this->_tag_stack[] = array('dynamic', array()); $_block_repeat=true;smarty_block_dynamic($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if ($this->_tpl_vars['user_name'] && $this->_tpl_vars['active'] == 0): ?>
			<div id="userinfo">
					<h3>用户登录</h3>
...
<?php else: ?>templates/default/images/nopic.gif<?php endif; ?>"/></a>
			...
			<?php endif; ?><?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_dynamic($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); if ($this->caching && !$this->_cache_including): echo '{/nocache:aa1aff3a524538eafd5457f6d9b247ce#0}'; endif;?>
			<div id="ann">
