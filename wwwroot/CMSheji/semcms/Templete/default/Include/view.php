...
$products_metatits=proview($ID,"products_metatit",$web_url);
$products_aurls=proview($ID,"products_aurl",$web_url);

?>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<title><?php if(empty($products_metatits)){echo proview($ID,"products_name",$web_url);}else{echo proview($ID,"products_metatit",$web_url);}?></title>
    	...
    	<div class="sc_mid_c">
            ...
            <div class="sc_mid_proveiw_1">
                ...
                <div class="sc_mid_proview_1_right">
                    ...
                    <li><span class='binq'><a href="#buynow"><?php echo $tag_inquiry;?></a></span> <?php if(!empty($products_aurls)){echo "<span id='amz'><a href='".proview($ID,'products_aurl',$web_url)."'>Buy Now</a>";}?></a></li>
