...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
   ...
   <tr><td width="200" align="center">首页标题(meta title)</td><td><input name="tag_indexmetatit" type="text" id="tag_indexmetatit" value="<?php echo $row['tag_indexmetatit'];?>" size="70" > </td></tr>
   ...
   <tr><td width="200" align="center">产品列表标题(meta title)</td><td><input name="tag_prometatit" type="text" id="tag_prometatit" value="<?php echo $row['tag_prometatit'];?>" size="70" > </td></tr>
   ...
   <tr><td width="200" align="center">新闻信息列表标题(meta title)</td><td><input name="tag_newmetatit" type="text" id="tag_newmetatit" value="<?php echo $row['tag_newmetatit'];?>" size="70" > </td></tr>
