...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
   ...
   <tr>
             ...
             <td width="200" align="center">产品标题(meta title) </td><td><input name="products_metatit" type="text" id="products_metatit" size="60" > <span class="red"> 可为空,当为空时显示产品名称   </span></td></tr>
...
<table width="98%" class="table" cellpadding="0" cellspacing="0">
   ...
   <tr>
             ...
             <td width="200" align="center">产品标题(meta title) </td><td><input name="products_metatit" type="text" id="products_metatit" size="60" value="<?php echo $row['products_metatit']; ?>">  <span class="red"> 可为空,当为空时显示产品名称   </span></td></tr>
