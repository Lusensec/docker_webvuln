...
if ($CF=="category"){  //商品分类----------------------------------
     ...
     if($Class=="add"){ //增加产品
          ...
          $languageID=test_input($_POST["languageID"]);
            ...
            //记录写入数据库
            mysql_query("INSERT INTO sc_products(products_category,products_name,products_model,products_key,products_des,products_Images,products_url,products_paixu,products_xiangguan,products_content,products_aurl,products_metatit,languageID)"
         . "VALUES ('$products_category','$products_name','$products_model','$products_key','$products_des','$ImgUrl','$products_url','$products_paixu','$products_xiangguan','$contents','$products_aurl','$products_metatit','$languageID')");
          ...
          $products_ls=$_POST['products_ls'];
           ...
           mysql_query("UPDATE sc_products SET  products_category='$products_category',products_name='$products_name',"
                   ...
                   . "products_content='$contents',products_time='$gxtime',products_metatit='$products_metatit',products_aurl='$products_aurl' where ID='$ID'");       
    ...
    if($Class=="edit"){
        ...
        // 添加
         ...
         mysql_query("INSERT INTO sc_tagandseo(tag_indexkey,tag_indexdes,tag_prokey,tag_prodes,tag_newkey,tag_newdes,"
                 ...
                 . "tag_messgets,tag_more,tag_code,tag_searchtit,tag_inquiry,tag_Item,tag_follow,tag_homeabout,tag_contacts,tag_indexmetatit,tag_prometatit,tag_newmetatit,languageID)"
         . "VALUES ('$tag_indexkey','$tag_indexdes','$tag_prokey','$tag_prodes','$tag_newkey','$tag_newdes','$tag_home','$tag_about'"
                 ...
                 . ",'$tag_messgetj','$tag_messgets','$tag_more','$tag_code','$tag_searchtit','$tag_inquiry','$tag_Item','$tag_follow','$tag_homeabout','$tag_contacts','$tag_indexmetatit','$tag_prometatit','$tag_newmetatit','$languageID')");
        }else{
        ...
        mysql_query("UPDATE sc_tagandseo SET tag_indexkey='$tag_indexkey',tag_indexdes='$tag_indexdes',tag_prokey='$tag_prokey',"
                 ...
                 . "tag_more='$tag_more',tag_code='$tag_code',tag_searchtit='$tag_searchtit',tag_inquiry='$tag_inquiry',tag_Item='$tag_Item',tag_time='$tag_time',tag_follow='$tag_follow',tag_homeabout='$tag_homeabout',tag_indexmetatit='$tag_indexmetatit',tag_prometatit='$tag_prometatit',tag_newmetatit='$tag_newmetatit',tag_contacts='$tag_contacts' where languageID=$languageID"); 
